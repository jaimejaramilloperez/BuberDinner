...
public static partial class Constants
{
    public static class Menu
    {
        ...
        public static string SectionNameFromIndex(int index) => $"{SectionName} {index + 1}";
        public static string SectionDescriptionFromIndex(int index) => $"{SectionDescription} {index + 1}";

        public static string ItemNameFromIndex(int index) => $"{ItemName} {index + 1}";
        public static string ItemDescriptionFromIndex(int index) => $"{ItemDescription} {index + 1}";
    }
}
